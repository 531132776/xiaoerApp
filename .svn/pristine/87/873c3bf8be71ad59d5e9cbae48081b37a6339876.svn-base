    ...
    export default {
        ...
        methods:{
            ...
            dealershop(companyId,companyName,companyLogo,item){
                this.$store.commit('dealershop',{companyId,companyName,companyLogo,item});
                this.$router.push({
                    name: 'dealershop',
                    params:{
                        id:companyId,
